...
type Language = "english" | "dutch" | "chinese";
...
export default function SchedulePage() {
  ...
  // Booking form state - pre-selected for the task
  const [bookingDay, setBookingDay] = useState<string>("Saturday");
  const [bookingTime, setBookingTime] = useState<string>("13:00");
  const [bookingLanguage, setBookingLanguage] = useState<Language>("english");
  ...
  const addToProgram = () => {
    ...
    setShowProgram(true);
    toast.success("Added to your personal program!", {
      description: `${bookingDay} at ${bookingTime} - ${languageConfig[bookingLanguage].label} tour`,
    });
  };
  ...
  const getSlotAvailability = (day: string, time: string, language: Language) => {
    ...
    <div className="pt-36">
      ...
      <section className="py-12 md:py-16 bg-primary text-primary-foreground relative overflow-hidden">
        <div className="absolute inset-0 opacity-10">
          <div className="absolute top-0 left-1/4 w-72 h-72 bg-white/20 rounded-full blur-3xl" />
                ...
                <div className="p-6 space-y-6">
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-3 gap-2">
                      {["10:00", "13:00", "16:00"].map((time) => {
                        const available = getSlotAvailability(bookingDay, time, bookingLanguage) > 0;
                        return (
                          <button
                            key={time}
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-3 gap-2">
                      {(Object.keys(languageConfig) as Language[]).map((lang) => {
                        const available = getSlotAvailability(bookingDay, bookingTime, lang) > 0;
                        return (
                          <button
                            key={lang}
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      ...
                      <button
                        onClick={() => { setTicketType("family"); setBookingPeople(4); }}
